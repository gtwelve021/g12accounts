...
import { outlineButtonClass, primaryButtonClass } from "@/components/ui-classes";
...
export default function ThankYouPage() {
  return <main className="relative grid min-h-svh place-items-center overflow-hidden bg-[linear-gradient(130deg,#030b1c,#071a3c_58%,#123b7e)] px-6 pt-[150px] pb-[85px] text-white max-[520px]:pt-[120px]">
    ...
    <section className="relative z-10 w-full max-w-[900px] text-center">
      ...
      <div className="mt-11 flex items-center justify-center gap-[35px] max-[800px]:flex-col max-[520px]:mt-[35px]"><Link className={primaryButtonClass} href="/">Return to homepage <span>↗</span></Link><a className={`${outlineButtonClass} border-white/[.35]`} href="https://g12accounts.ae/insights/">Explore our insights</a></div>
    </section>
